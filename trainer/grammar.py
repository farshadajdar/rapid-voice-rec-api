words = [
    "apple", "boy", "cat", "dog", "egg", "fish", "go", "hat", "ice", "job",
    "key", "love", "man", "no", "open", "play", "queen", "run", "sun", "time",
    "up", "very", "win", "box", "yes", "zoo"
]
...
# 📦 Generate full grammar phrases (word + number + word)
def generate_grammar():
    return [f"{w1} {number} {w2}" for w1 in words for number in numbers for w2 in words]
